...
projects: [charmer-9334, tfutils-go-9337]
excerpt: "Charmer is a Go library that takes annotated functions and automatically builds a navigable TUI around them — removing the need to manually implement the UI for command-line tools."
draft: false
---
