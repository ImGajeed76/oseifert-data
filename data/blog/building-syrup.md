---
title: "Syrup: Building an Open-Source, Ethical Alternative to Honey"
slug: building-syrup
date: "2025-10-21"
tags: [go, postgresql, redis, open-source, browser-extension, api]
projects: [syrup-9089, discountdb-api-9117]
excerpt: "Building an open-source, privacy-respecting coupon browser extension — from designing the Go backend with PostgreSQL and Redis to becoming a maintainer on the project."
draft: false
---
